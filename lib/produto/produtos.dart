                ...
                child: Center(
                    child: SizedBox(
                        ...
                        child: Column(children: [
                          const SizedBox(height: 135, child: HeaderTwo()),
                          ...
                          const SizedBox(height: 30),
                          FutureBuilder(
                              future: Future.wait([_data, _category, _perfil]),
                              builder: (BuildContext context,
                                ...
                                if (snapshot.connectionState ==
                                  ...
                                  int val = random
                                      .nextInt(snapshot.data!.length - 1 + 1);
                                    ...
                                    Row(children: [
                                      Expanded(child: LayoutBuilder(builder:
                                        ...
                                        return FittedBox(
                                            fit: BoxFit.scaleDown,
                                            alignment: Alignment.centerLeft,
                                            child: Text(snapshot.data![2]['name'],
                                                style: TextStyle(
                                                    color: Color(0xFF3D3D3D),
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 24)));
                                                        ...
                                                        return Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                ...
                                                                image: DecorationImage(
                                                                    image: obterImagem(snapshot.data![0]
                                                                            [val][
                                                                        'images']),
                                                                    fit: BoxFit
                                                                        .fitWidth)));
                                                                    ...
                                                                    child: LayoutBuilder(builder: (BuildContext
                                                                      ...
                                                                      return Container(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              style: const TextStyle(color: Color(0xFF000000), height: 1.15, fontWeight: FontWeight.bold, fontSize: 16)));
                                                                    })),
                                                                const Spacer(),
                                                                Expanded(
                                                                  flex: 4,
                                                                        ...
                                                                        children: [
                                                                          Expanded(child:
                                                                            ...
                                                                            return FittedBox(
                                                                                fit: BoxFit.scaleDown,
                                                                                alignment: Alignment.center,
                                                                                child: Text('${snapshot.data![1][index]['name']}', style: const TextStyle(color: Color(0xFFFFFFFF), fontWeight: FontWeight.bold, fontSize: 14)));
                                                                          })))
                                                                        ])
                                                                  ]))));
                                                }))),
